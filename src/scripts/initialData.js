...
const formEdit = document.querySelector('.modal__form_edit');
const formAdd = document.querySelector('.modal__form_add');
const avatarButton = document.querySelector('.profile__avatar-edit');
const avatarModal = '.modal_type_avatar';
const formAvatar = document.querySelector('.modal__form_avatar');
